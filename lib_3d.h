...
static void (*remplirTriangle3d)(t_surface * surface, t_triangle3d * triangle, Uint32 c, double l, double h, double d) = remplirTriangle3d_PA;

static void (*translationTriangle3d)(t_triangle3d *t, t_point3d *vecteur) = translationTriangle3d_PA;
static void (*rotationTriangle3d)(t_triangle3d *t, t_point3d *centre, float degreX, float degreY, float degreZ) = rotationTriangle3d_PA;
